...
complete -c pond -n "__fish_use_subcommand" -a q -d "Stateless query (supports piping)"
complete -c pond -n "__fish_use_subcommand" -a query -d "Stateless query (supports piping)"
complete -c pond -n "__fish_use_subcommand" -a ask -d "Stateless query (supports piping)"
