...
from pond.engine import get_commandline_history, get_response
...
@patch('pond.engine.get_config')
@patch('pond.engine.get_openai_client')
def test_get_chat_response_redacts_before_provider_call(mock_client, mock_config):
    from pond.engine import get_chat_response
...
def test_bedrock_happy_path(mock_get_config):
    ...
    with patch('pond.engine.get_openai_client',
...
def test_bedrock_constructs_mantle_url(mock_get_config):
    ...
    with patch('openai.OpenAI') as mock_openai_cls:
        from pond.engine import get_openai_client
        get_openai_client()
